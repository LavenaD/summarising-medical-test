"""
Django settings for summarising_medical_test_api project.
...
ROOT_URLCONF = 'summarising_medical_test_api.urls'
...
WSGI_APPLICATION = 'summarising_medical_test_api.wsgi.application'
